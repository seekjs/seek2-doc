...
define(function (req, app) {
    ...
    app.loadView = function (ops) {
        ...
        */
        var jsFile = app.getPath(ops, "controller");
    ...
    app.chkStyle = function(view){
        if(view.cssFile!="none"){
			var dir = app.dir || "main";
			if(app.path[dir].style){
				var cssFile = view.cssFile || app.getPath(view, "style");
    ...
    app.loadTemplate = function (view) {
        var templateFile = view.templateFile || app.getPath(view, "view");
    ...
    app.parseTemplate2 = function (view) {
        ...
        */
        ...
        app.onRender && app.onRender(context,view);
        view.onRender && view.onRender(context);

        //延时
        window.setTimeout(function () {
            //app.usegrid && grid.use(view.ui);
            app.onLoad && app.onLoad(context, view);
            view.onLoad && view.onLoad(context);
